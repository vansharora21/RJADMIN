    ...
    >
      <div className="flex flex-col items-center w-full px-2">
        ...
        <div className="mb-8 flex flex-col items-center">
          <div className="bg-white/10 p-4 rounded-full shadow-lg mb-2 border border-orange-300">
            <img
              src={logo}
              alt="Logo"
          ...
          {/* Optional: Brand Name under the logo */}
          {/* <p className="text-white text-xl font-bold tracking-wide">Your Brand</p> */}
        </div>

        {/* Card/Form Section */}
        <div className="bg-black bg-opacity-70 rounded-xl shadow-lg p-0 flex flex-col items-center">
          <form
